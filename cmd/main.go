...
func main() {
	...
	if _, err = dc.ServerResourcesForGroupVersion("gateway.networking.k8s.io/v1"); err != nil {
		setupLog.Error(err, "Gateway API CRDs not found - install them before running Meridian")
		os.Exit(1)
	}
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID:       "32f6187b.ntentas.com",
